...
{% include pattern-figure.html image="({{ site.url }}/assets/images/fb-deactivated.jpg" caption="Comment from a YouTube thread" width="1135" height="244" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/fb-deactivated-02.jpg" caption="Comment from a YouTube thread" width="1135" height="244" %}
