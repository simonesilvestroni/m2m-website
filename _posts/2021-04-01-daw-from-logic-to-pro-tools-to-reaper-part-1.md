...
{% include pattern-figure.html image="({{ site.url }}/assets/images/daw-logic-platinum.jpg" caption="2002: Logic Audio Platinum 5" width="768" height="581" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/daw-protools-error.png" caption="Not very useful Pro Tools error message" width="768" height="258" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/daw-reaper-preferences.jpg" caption="Import and export REAPER’s configuration" width="768" height="513" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/daw-pro-tools-new-tracks.jpeg" caption="Create new tracks in Pro Tools" width="500" height="179" %}

{% include pattern-figure.html image="({{ site.url }}/assets/images/daw-logic-pro-x-new-track.png" caption="Create new tracks in Logic Pro X" width="1262" height="654" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/daw-reaper-create-new-tracks.jpg" caption="REAPER: create new track(s)" width="694" height="372" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/daw-reaper-routing-track.png" caption="The routing window from a track in REAPER" width="768" height="291" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/daw-reaper-drag-send.png" caption="Create a send from one track to another by dragging the route icon (“IO” in my skin) to a track" width="768" height="692" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/daw-reaper-folder.png" caption="A folder in REAPER, with its shadow region at the top" width="768" height="183" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/daw-reaper-grouping-matrix.png" caption="REAPER grouping matrix" width="768" height="466" %}
