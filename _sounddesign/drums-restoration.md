...
<div class="alert m2m-bg-alpha rounded-3 px-4 py-4 my-5">
  <h3 class="text-center mt-0"><strong>Noise: before</strong></h3>
...
<div class="alert m2m-bg-alpha rounded-3 px-4 py-4 my-5">
  <h3 class="text-center mt-0"><strong>Noise: after</strong></h3>
...
<div class="alert m2m-bg-alpha rounded-3 px-4 py-4 my-5">
  <h3 class="text-center mt-0"><strong>Mono drums overhead: before</strong></h3>
...
<div class="alert m2m-bg-alpha rounded-3 px-4 py-4 my-5">
  <h3 class="text-center mt-0"><strong>Mono drums overhead: after</strong></h3>
