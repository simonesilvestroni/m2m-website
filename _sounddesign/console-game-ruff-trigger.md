...
toc: true
featimage: true
featimage-url: '({{ site.url }}/assets/images/ruff-trigger-console-game.jpg'
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/playstos-studio.jpg" caption="Audio studio, circa 2002" width="800" height="531" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/playstos-studio-2.jpg" caption="Audio studio, 2003 (Xbox SDK visible at the top of the rack)" width="1200" height="900" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/xact_microsoft.jpg" caption="Microsoft XACT v2.0" width="850" height="540" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/gdc-2002-entrance.jpg" caption="GDC 2002: Entrance of the Convention Center in San Jose" width="640" height="480" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/gdc-2002-attendants.jpg" caption="GDC 2002: Attendance at a workshop" width="768" height="519" %}
...
{% include pattern-figure.html image="({{ site.url }}/assets/images/gdc-2002-locator-badge.jpg" caption="GDC 2002: Conference locator and my entrance badge" width="758" height="1024" %}
