...
skillset:
 ...
 - html
 - sass
description: 'In a quest to continuous performance optimization, my image gallery carousel in pure HTML and CSS features responsive images and touch controls for mobile devices.'
excerpt: false
